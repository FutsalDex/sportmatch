...
export const MOCK_USERS: User[] = [
  ...
  { id: 'c3', name: 'Luis Enrique B.', role: 'Coach', discipline: 'Football', province: 'Gijón', status: 'available', score: 94, level: 'Professional', avatarUrl: 'https://picsum.photos/seed/c3/100/100', verificationStatus: 'verified', position: 'Director Técnico', age: 45 },
  ...
  { id: 'c8', name: 'Carla Fluxá', role: 'Coach', discipline: 'Futsal', province: 'Palma', status: 'available', score: 75, level: 'Amateur', avatarUrl: 'https://picsum.photos/seed/c8/100/100', verificationStatus: 'none', position: 'Entrenador Base', age: 28 },
  ...
  { id: 'c10', name: 'Xavi Pascual F.', role: 'Coach', discipline: 'Futsal', province: 'Barcelona', status: 'available', score: 95, level: 'Professional', avatarUrl: 'https://picsum.photos/seed/c10/100/100', verificationStatus: 'verified', position: 'Estratega Senior', age: 55 },
